...
export default {
  ...
  "device.pl_item.orphan_zone_tip":
    "This item's zone isn't part of the device's current layout. It still plays (recovered into the largest zone), but reassign it to a zone in this layout.",
  "dashboard.device_orphan_tip_one":
    "{n} item assigned to a zone that isn't in this device's layout — open the device to reassign",
  "dashboard.device_orphan_tip_other":
    "{n} items assigned to a zone that isn't in this device's layout — open the device to reassign",
  // #139: device stuck in OTA backoff (can't self-install — e.g. Fire TV) — needs a manual update.
  "dashboard.device_ota_stuck":
    "Update available (v{version}) — install failed {n}×, manual update required",
  // Nav (sidebar)
  ...
  "dashboard.help_tip":
    "Your paired display devices. Green = online, red = offline. Click a device to manage its playlist, view telemetry, or use remote control.",
  ...
  "dashboard.no_displays_desc":
    "Install the BeamOS app on your TV and pair it using the button above.",
  ...
  "dashboard.confirm_add_to_group":
    '{name} is already in: {groups}\n\nAdd it to "{target}" too?',
  "dashboard.confirm_assign_playlist":
    'Assign playlist "{playlist}" to all devices in "{group}"?',
  "dashboard.confirm_destructive_command":
    '{cmd} all {n} devices in "{group}"?\n\nThis cannot be undone.',
  "dashboard.confirm_delete_group":
    "Delete this group? Devices will not be affected.",
  // Dashboard toasts
  ...
  "dashboard.toast.command_sent_with_offline":
    "{cmd} sent to {sent}/{total} devices ({offline} offline)",

  // Content library
  "content.title": "Content Library",
  "content.subtitle": "Upload and manage your media files",
  "content.help_tip":
    "Upload videos and images here. Select multiple files for bulk upload. Use Remote URL to stream from external sources. Click a thumbnail to preview.",
  ...
  "content.confirm_delete_folder":
    "Delete this folder? Content inside moves back to the root level. Subfolders will also be deleted.",
  // Empty states
  ...
  "device.tab.now_playing_tip":
    "Live screenshot of what's currently displaying on this device.",
  "device.tab.playlist": "Playlist",
  "device.tab.playlist_tip":
    "Content assigned to this device. Drag items to reorder. Add media, widgets, or kiosk pages.",
  "device.tab.info": "Device Info",
  "device.tab.info_tip":
    "Hardware telemetry, orientation settings, notes, and device controls.",
  "device.tab.remote": "Remote Control",
  "device.tab.remote_tip":
    "View the device screen in real-time and send key presses. Works on Android APK and web player.",
  // Draft banner
  "device.draft.banner_title": "Unpublished changes",
  "device.draft.devices_showing_published":
    "Devices are still showing the last published version.",
  "device.draft.never_published":
    "This playlist has never been published. Devices will show nothing until you publish.",
  ...
  "device.debug.hint":
    "Streams player/zone logs from this device in real time. Turns off on its own when the device reconnects.",
  ...
  "device.remote.system_view_tooltip":
    "Prompts the device user to allow full screen capture - enables remote view of home screen, settings, and other apps",
  ...
  "device.copy.prompt":
    "Copy playlist to which device?\n\n{list}\n\nEnter number:",
  "device.copy.invalid_selection": "Invalid selection",
  "device.copy.toast": "Copied {n} items to {device}",
  // Add-content modal
  "device.assign.empty_all":
    "No content, widgets, or kiosk pages yet. Create something first!",
  ...
  "device.assign.zone_no_layout":
    "This device has no layout assigned. Content will play fullscreen. Pick a layout from the Layout dropdown on this device to use zones.",
  "device.assign.zone_load_failed":
    "Layout zones could not be loaded. Try refreshing the page.",
  "device.assign.zone_empty_layout": "This layout has no zones defined.",
  "device.assign.duration_label":
    "Display Duration (seconds, for images/widgets)",
  ...
  "device.toast.command_undeliverable":
    "{cmd} — device offline and queue unavailable",
  ...
  "apitoken.desc":
    "Personal access tokens for the public API, scoped to this workspace. Treat them like passwords — anyone with the token can act as you here.",
  ...
  "apitoken.agency_playlists_hint":
    "The token can upload and add date-bounded items to these playlists only. Additions land as drafts for you to publish.",
  "apitoken.agency_needs_playlists":
    "Select at least one playlist for an agency token.",
  "apitoken.agency_no_playlists":
    "Create a playlist first — an agency token must target one.",
  "apitoken.targets_label": "Designated:",
  "apitoken.edit_targets": "Edit playlists",
  "apitoken.zoned_playlist_reason":
    "Assigned to a zone — agencies need a full-screen playlist",
  ...
  "apitoken.auto_publish_hint":
    "Off (default): additions wait as drafts for you to publish. On: they go live immediately — only for agencies you fully trust.",
  ...
  "apitoken.secret_warning":
    "This is the only time the full token is shown. Store it somewhere safe — you won't be able to see it again.",
  "apitoken.copy": "Copy",
  ...
  "provisioning.show_qr_device_owner": "Generate as Device Owner QR",
  "provisioning.qr_device_owner_alt": "Device Owner provisioning QR code for {code}",
  "provisioning.device_owner_qr_note": "Scan this from a factory-reset device's setup screen (tap the screen 6 times to start QR provisioning) - it installs the app, makes it Device Owner, and activates this display automatically. It won't do anything scanned from an already-set-up device.",
  ...
  "settings.sso_note":
    "You sign in via {provider}. Manage your password there.",
  "settings.license": "License",
  "settings.license_mit": "MIT License - all features included.",
  "settings.organization": "Organization",
  "settings.organization_desc":
    "Manage who has owner/admin access to {org}.",
  "settings.manage_org_members": "Manage Organization Members",
  ...
  "settings.hide_branding": 'Hide "BeamOS" branding',
  "settings.save_branding": "Save Branding",
  "settings.preview": "Preview",
  "settings.white_label_enterprise_only":
  ...
  "settings.setup_step_1": "Install the BeamOS APK on your TV via sideloading",
  ...
  "settings.import.zip_detected":
    "ZIP export detected: <strong>{name}</strong> ({size} MB)<br>Contains data + media files.",
  "settings.import.confirm": "Confirm Import",
  "settings.import.invalid_file":
    "Invalid file. Must be a BeamOS export JSON or ZIP.",
  ...
  "settings.import.found_summary":
    "Found: {summary}.<br>From: {email} (exported {date})",
  "settings.import.empty_export": "empty export",
  "settings.import.uploading_zip":
    "Uploading and importing... This may take a moment for large files.",
  ...
  // Settings toasts
  "settings.toast.support_token_generated":
    "Support token generated (valid {hours}h)",
  ...
  "settings.toast.new_password_min_8":
  ...
  "settings.user.prompt_reset_password":
    "Enter a new password for {email} (minimum 8 characters):",
  ...
  "widget.help_tip":
    "Dynamic content elements: live clocks, weather, RSS tickers, text, webpages, and social feeds. Create a widget then assign it to a device playlist.",
  ...
  "widget.webpage_blocked_note":
    "If this area is blank, the site blocks embedding in a browser — it will still display on the device screen.",
  "widget.close": "Close",
  ...
  "widget.type.directory_board.desc":
    "Scrolling tenant/room directory for lobbies",
  ...
  "widget.picker.no_images":
    "No images in your content library. Upload images first from Content Library.",
  ...
  "widget.dir.confirm_delete_category":
    'Delete category "{name}" and all its entries?',
  ...
  "designer.ai.placeholder":
    "Describe your sign — e.g. 'Summer sale, 20% off mains, bright modern'",
  ...
  "designer.ai.done_imgwarn":
    "Generated {n} element(s) — an image couldn’t be generated (text is ready). Publish.",
  "designer.ai.images_title": "AI images (optional)",
  "designer.ai.images_desc":
    "Generate a background (and a foreground graphic) from your prompt. Point at a local sd.cpp / ComfyUI server or OpenAI. Off = text + shapes only.",
  ...
  "designer.ai.image_model_ph":
    "optional — e.g. dall-e-3; blank for sd.cpp / ComfyUI",
  ...
  "designer.ai.image_key_hint":
    "Only if your image provider needs a different key than your text endpoint (e.g. local LLM + OpenAI images). Blank reuses the key above; local sd.cpp / ComfyUI need none.",
  ...
  "designer.ai.settings_desc":
    "Bring your own OpenAI-compatible endpoint — OpenAI cloud, or self-hosted Ollama / LM Studio. Your provider bills you; the key is stored encrypted and never shown again.",
  ...
  "designer.ai.key_hint":
    "Stored encrypted, server-side. Local endpoints (Ollama) usually need no key.",
  "designer.ai.saved": "AI settings saved",
  "designer.ai.save_failed": "Could not save AI settings",
  "designer.help_tip":
    "Create custom signage with live elements: clocks, weather, RSS tickers, countdowns, QR codes. Publish as a widget or export as PNG.",
  ...
  // Toasts
  "designer.toast.published":
    "Published as widget! Assign it to a layout zone.",
  ...
  "playlist.all_auto_generated":
    'All playlists are auto-generated. Toggle "Show auto-generated" to see them.',
  ...
  "itemsched.hint":
    "Items without a schedule always play. Add blocks to limit when this item appears — evaluated in each screen's local time.",
  ...
  "itemsched.toast.saved":
    "Schedule saved — publish the playlist to push it to devices",
  ...
  "device.clock.skew":
    "⚠ clock off by {amount} — schedules may fire at the wrong local time",
  ...
  "onboarding.step.welcome.title": "Welcome to BeamOS!",
  "onboarding.step.welcome.intro": "Let's get you set up in under 5 minutes.",
  "onboarding.step.welcome.guide_through":
  ...
  "onboarding.step.player.url_hint":
  ...
  "onboarding.step.done.intro":
    "Your display is paired and content is playing!",
  "onboarding.step.done.whats_next": "What's next?",
  "onboarding.step.done.next_content":
    "Add more content in the <strong>Content Library</strong>",
  "onboarding.step.done.next_layouts":
    "Create multi-zone layouts in <strong>Layouts</strong>",
  "onboarding.step.done.next_schedule":
    "Set up a schedule in the <strong>Schedule</strong> calendar",
  "onboarding.step.done.next_widgets":
    "Add live widgets (clock, weather, ticker) in <strong>Widgets</strong>",
  "onboarding.step.done.next_kiosk":
    "Create interactive screens in <strong>Kiosk</strong>",
  "onboarding.step.done.next_designer":
    "Design custom content in the <strong>Designer</strong>",
  ...
  "admin.create_org.hint":
    "Creates the organization and its first workspace, owned by you. Add the customer's users afterward with Add User.",
  ...
  "admin.orgs.desc":
    "Every organization and its workspaces. Deleting cascades all devices, content, playlists and memberships — this is irreversible.",
  ...
  "admin.orgs.manage_members": "Members",
  ...
  "admin.orgs.delete_org_body":
    "This permanently deletes <b>{name}</b> and all of its workspaces, devices, content, playlists and memberships. This cannot be undone.",
  "admin.orgs.delete_ws_title": "Delete workspace",
  "admin.orgs.delete_ws_body":
    "This permanently deletes workspace <b>{name}</b> and all of its devices, content and playlists. The organization is kept. This cannot be undone.",
  ...
  "admin.branding.desc":
    "Instance-wide default. Every workspace that hasn't set its own white-label inherits this, as does the login page.",
  ...
  "manage_ws.staff_note":
    "This user has platform-wide access; the memberships below are in addition to that.",
  ...
  "schedule.help_tip":
    "Visual weekly calendar for content scheduling. Click Add Schedule to create time slots. Set recurrence for repeating content. Higher priority overrides lower. Device-level schedules override group-level.",
  ...
  "schedule.no_groups_msg":
    "No groups created yet. Create groups in the Displays page.",
  "schedule.zone_note":
    "Note: Zone-based schedules are layout-specific. Ensure all devices in the group use the same layout.",
  ...
  "kiosk.help_tip":
    "Create interactive touchscreen interfaces. Add buttons with icons and actions. Includes idle screen that shows after inactivity. Assign to devices as a widget.",
  ...
  "layout.help_tip":
    "Create multi-zone screen layouts. Use templates or build custom ones. Drag zones to position, resize with corner handle. Assign layouts to devices in the Playlist tab.",
  ...
  "layout.fit_hint":
    "How video/images scale to the zone. Contain shows the whole frame without cropping.",

  // Video walls
  "wall.title": "Video Walls",
  "wall.subtitle": "Combine multiple displays into one large screen",
  "wall.help_tip":
    "Combine multiple displays into one large screen. Set grid size, drag devices into positions, adjust bezel compensation. Assign content to play across all devices.",
  ...
  "team.help_tip":
    "Create teams to share devices with other users. Owners manage the team, editors can change content/playlists, viewers can only monitor.",
  ...
  "add_display.need_player":
    "Need a player app? Install one to get a pairing code:",
  ...
  "add_display.smart_tv_note":
    'Smart TVs (LG/Samsung): open the built-in browser and navigate to <code style="background:var(--bg-input,#0f172a);padding:1px 4px;border-radius:3px">/player</code>',
  ...
  "members.error.last_admin_demote":
    "Cannot change role - this user is the only admin.",
  ...
  // Organization members view (org_owner/org_admin) - reached from the Admin
  // panel's Organizations list. Reuses members.role.org_owner/org_admin.
  "org_members.title": "Organization members",
  "org_members.loading": "Loading...",
  "org_members.section.members": "Members",
  "org_members.col.role": "Role",
  "org_members.empty": "No organization members yet.",
  "org_members.load_error": "Failed to load members: {error}",
  "org_members.org_not_found": "Organization not found or no access.",
  "org_members.button.add": "Add member",
  "org_members.button.remove": "Remove member",
  "org_members.confirm.remove_member": "Remove {name} from this organization?",
  "org_members.modal.add_title": "Add member to {org}",
  "org_members.modal.email_label": "Email",
  "org_members.modal.email_placeholder": "user@example.com",
  "org_members.modal.role_label": "Role",
  "org_members.modal.cancel": "Cancel",
  "org_members.modal.add": "Add member",
  "org_members.modal.adding": "Adding...",
  "org_members.error.user_not_found": "No account exists for that email yet - the user must sign up first.",
  "org_members.error.already_member": "This user is already a member of the organization.",
  "org_members.error.last_owner_demote": "Cannot demote the last organization owner.",
  "org_members.error.last_owner_remove": "Cannot remove the last organization owner.",
  "org_members.error.primary_owner_protected": "This is the organization's primary owner and can't be changed or removed here.",
  "org_members.error.owner_grant_forbidden": "Only a platform admin can grant or change the organization owner role.",
  "org_members.error.invalid_email": "Please enter a valid email address.",
  "org_members.error.mutation_generic": "Action failed: {error}",
  ...
  "forcepw.subtitle":
    "Your account was set up by an administrator. Choose your own password to continue.",
  ...
  "noworkspace.body":
    "Your account isn't part of any workspace yet. Ask your administrator to add you to one, then sign in again.",
  ...
  "accept.error.expired":
    "This invite has expired - ask the admin for a new one",
  "accept.error.wrong_account":
    "This invite is for a different email address. Sign out and sign in with the right account.",
  "accept.error.generic":
    "Failed to accept invite. Try again or contact your admin.",
};
